...
st.markdown("<h1 style='text-align: center;'>تُشكل الرياض 43% من إجمالي الوظائف في المملكة، وذلك بفضل كونها العاصمة وما شهدته من تطوير كبير في مجال الترفيه. فقد ازدادت الفعاليات والمشاريع الترفيهية الجديدة، مما أتاح المزيد من الفرص الوظيفية. تأتي مكة المكرمة في المرتبة الثانية بنسبة 25%، حيث تستقطب المدينة ملايين الزوار سنويًا لأداء مناسك الحج والعمرة، مما يعزز على توفير الوظائف.أما المنطقة الشرقية، فتحتل المرتبة الثالثة بنسبة 16.4% ، إذ تحتوي على أكبر حقول النفط في المملكة وتضم مدينة صناعية مهمة، مما يسهم أيضًا في توفير فرص عمل متعددة. </h1>", unsafe_allow_html=True)
